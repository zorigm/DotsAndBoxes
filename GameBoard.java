...
public class GameBoard extends JPanel implements MouseListener{
	...
	public GameBoard(GameFrame gf)
	{
		...
		if(this.gameType > 1)
		{
			AIMatch(this.gameType);
			this.ai = new AI(this.gameType, this.allBoxes, this.tb, this);
		}
		
		
	}
	public void AIMatch(int i)
	{
		this.p2.setType(i);
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		this.repaint();
		if(this.tb.checkGameOver(this.allBoxes))
		{
			GameOver go = new GameOver(this.gf, this.gameType, this);
		}
	}
