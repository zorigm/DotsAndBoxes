...
//	}
	...
	public GameSplash(Director d) {
		...
		contentPane.setMinimumSize(new Dimension(700, 450));
		contentPane.setMaximumSize(new Dimension(700, 450));
		...
		JLabel lblNewLabel = new JLabel("  Dots & Boxes! ");
		...
		this.pvha = new JLabel(" Player v Hard AI");
		this.pvha.setFont(new Font("Courier New", Font.PLAIN, 32));
		this.pvha.setForeground(Color.WHITE);
		panel.add(this.pvha);
		
		
		this.pvp.addMouseListener(this);
		this.pvha.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(e.getSource() == this.pvha)
		{
			this.d.setGameType(3);
			this.d.launchGame();
	...
	public void mouseEntered(MouseEvent e) {
		...
		if(e.getSource() == this.pvha)
		{
			this.pvha.setForeground(Color.red);
